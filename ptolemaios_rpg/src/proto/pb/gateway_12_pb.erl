...
%% message types
-type gateway_c_login() :: #gateway_c_login{}.

-type gateway_p_role_info() :: #gateway_p_role_info{}.

-type gateway_s_login() :: #gateway_s_login{}.

-type gateway_c_select_role() :: #gateway_c_select_role{}.

-type gateway_s_select_role() :: #gateway_s_select_role{}.

-type gateway_c_create_role() :: #gateway_c_create_role{}.

-type gateway_s_create_role() :: #gateway_s_create_role{}.

-type gateway_c_heart() :: #gateway_c_heart{}.
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        gateway_c_login -> encode_msg_gateway_c_login(id(Msg, TrUserData), TrUserData);
        gateway_p_role_info -> encode_msg_gateway_p_role_info(id(Msg, TrUserData), TrUserData);
        gateway_s_login -> encode_msg_gateway_s_login(id(Msg, TrUserData), TrUserData);
        gateway_c_select_role -> encode_msg_gateway_c_select_role(id(Msg, TrUserData), TrUserData);
        gateway_s_select_role -> encode_msg_gateway_s_select_role(id(Msg, TrUserData), TrUserData);
...
encode_msg_gateway_c_login(Msg, TrUserData) -> encode_msg_gateway_c_login(Msg, <<>>, TrUserData).


encode_msg_gateway_c_login(#gateway_c_login{account = F1}, Bin, TrUserData) ->
    if F1 == undefined -> Bin;
       true ->
           begin
...
encode_msg_gateway_s_login(Msg, TrUserData) -> encode_msg_gateway_s_login(Msg, <<>>, TrUserData).


encode_msg_gateway_s_login(#gateway_s_login{account = F1, role_list = F2}, Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
            true ->
                begin
                    TrF1 = id(F1, TrUserData),
    ...
    begin
        TrF2 = id(F2, TrUserData),
        if TrF2 == [] -> B1;
           true -> e_field_gateway_s_login_role_list(TrF2, B1, TrUserData)
        end
    end.

encode_msg_gateway_c_select_role(Msg, TrUserData) -> encode_msg_gateway_c_select_role(Msg, <<>>, TrUserData).


encode_msg_gateway_c_select_role(#gateway_c_select_role{id = F1}, Bin, TrUserData) ->
    if F1 == undefined -> Bin;
       true ->
           begin
               TrF1 = id(F1, TrUserData),
...
encode_msg_gateway_s_select_role(Msg, TrUserData) -> encode_msg_gateway_s_select_role(Msg, <<>>, TrUserData).


encode_msg_gateway_s_select_role(#gateway_s_select_role{id = F1}, Bin, TrUserData) ->
    if F1 == undefined -> Bin;
       true ->
           begin
               TrF1 = id(F1, TrUserData),
...
encode_msg_gateway_s_create_role(Msg, TrUserData) -> encode_msg_gateway_s_create_role(Msg, <<>>, TrUserData).


encode_msg_gateway_s_create_role(#gateway_s_create_role{role_list = F1}, Bin, TrUserData) ->
    begin
        TrF1 = id(F1, TrUserData),
        if TrF1 == [] -> Bin;
           true -> e_field_gateway_s_create_role_role_list(TrF1, Bin, TrUserData)
        end
    end.
...
e_field_gateway_s_login_role_list([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_gateway_s_login_role_list(id(Elem, TrUserData), Bin2, TrUserData),
    e_field_gateway_s_login_role_list(Rest, Bin3, TrUserData);
e_field_gateway_s_login_role_list([], Bin, _TrUserData) -> Bin.

e_mfield_gateway_s_create_role_role_list(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_gateway_p_role_info(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_gateway_s_create_role_role_list([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_gateway_s_create_role_role_list(id(Elem, TrUserData), Bin2, TrUserData),
    e_field_gateway_s_create_role_role_list(Rest, Bin3, TrUserData);
e_field_gateway_s_create_role_role_list([], Bin, _TrUserData) -> Bin.
...
decode_msg_2_doit(gateway_c_login, Bin, TrUserData) -> id(decode_msg_gateway_c_login(Bin, TrUserData), TrUserData);
decode_msg_2_doit(gateway_p_role_info, Bin, TrUserData) -> id(decode_msg_gateway_p_role_info(Bin, TrUserData), TrUserData);
decode_msg_2_doit(gateway_s_login, Bin, TrUserData) -> id(decode_msg_gateway_s_login(Bin, TrUserData), TrUserData);
decode_msg_2_doit(gateway_c_select_role, Bin, TrUserData) -> id(decode_msg_gateway_c_select_role(Bin, TrUserData), TrUserData);
decode_msg_2_doit(gateway_s_select_role, Bin, TrUserData) -> id(decode_msg_gateway_s_select_role(Bin, TrUserData), TrUserData);
...
decode_msg_gateway_c_login(Bin, TrUserData) -> dfp_read_field_def_gateway_c_login(Bin, 0, 0, id(<<>>, TrUserData), TrUserData).

dfp_read_field_def_gateway_c_login(<<10, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> d_field_gateway_c_login_account(Rest, Z1, Z2, F@_1, TrUserData);
dfp_read_field_def_gateway_c_login(<<>>, 0, 0, F@_1, _) -> #gateway_c_login{account = F@_1};
dfp_read_field_def_gateway_c_login(Other, Z1, Z2, F@_1, TrUserData) -> dg_read_field_def_gateway_c_login(Other, Z1, Z2, F@_1, TrUserData).

dg_read_field_def_gateway_c_login(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_gateway_c_login(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_gateway_c_login(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_gateway_c_login_account(Rest, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_gateway_c_login(Rest, 0, 0, F@_1, TrUserData);
                1 -> skip_64_gateway_c_login(Rest, 0, 0, F@_1, TrUserData);
                2 -> skip_length_delimited_gateway_c_login(Rest, 0, 0, F@_1, TrUserData);
                3 -> skip_group_gateway_c_login(Rest, Key bsr 3, 0, F@_1, TrUserData);
                5 -> skip_32_gateway_c_login(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_gateway_c_login(<<>>, 0, 0, F@_1, _) -> #gateway_c_login{account = F@_1}.

d_field_gateway_c_login_account(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 57 -> d_field_gateway_c_login_account(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
d_field_gateway_c_login_account(<<0:1, X:7, Rest/binary>>, N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, {id(binary:copy(Bytes), TrUserData), Rest2} end,
    dfp_read_field_def_gateway_c_login(RestF, 0, 0, NewFValue, TrUserData).

skip_varint_gateway_c_login(<<1:1, _:7, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> skip_varint_gateway_c_login(Rest, Z1, Z2, F@_1, TrUserData);
skip_varint_gateway_c_login(<<0:1, _:7, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_c_login(Rest, Z1, Z2, F@_1, TrUserData).

skip_length_delimited_gateway_c_login(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 57 -> skip_length_delimited_gateway_c_login(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_gateway_c_login(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_gateway_c_login(Rest2, 0, 0, F@_1, TrUserData).

skip_group_gateway_c_login(Bin, FNum, Z2, F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_gateway_c_login(Rest, 0, Z2, F@_1, TrUserData).

skip_32_gateway_c_login(<<_:32, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_c_login(Rest, Z1, Z2, F@_1, TrUserData).
...
dfp_read_field_def_gateway_s_login(<<10, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> d_field_gateway_s_login_account(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_gateway_s_login(<<18, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> d_field_gateway_s_login_role_list(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_gateway_s_login(<<>>, 0, 0, F@_1, R1, TrUserData) -> #gateway_s_login{account = F@_1, role_list = lists_reverse(R1, TrUserData)};
dfp_read_field_def_gateway_s_login(Other, Z1, Z2, F@_1, F@_2, TrUserData) -> dg_read_field_def_gateway_s_login(Other, Z1, Z2, F@_1, F@_2, TrUserData).

dg_read_field_def_gateway_s_login(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) when N < 32 - 7 -> dg_read_field_def_gateway_s_login(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_gateway_s_login(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_gateway_s_login_account(Rest, 0, 0, F@_1, F@_2, TrUserData);
        18 -> d_field_gateway_s_login_role_list(Rest, 0, 0, F@_1, F@_2, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_gateway_s_login(Rest, 0, 0, F@_1, F@_2, TrUserData);
                1 -> skip_64_gateway_s_login(Rest, 0, 0, F@_1, F@_2, TrUserData);
                2 -> skip_length_delimited_gateway_s_login(Rest, 0, 0, F@_1, F@_2, TrUserData);
                3 -> skip_group_gateway_s_login(Rest, Key bsr 3, 0, F@_1, F@_2, TrUserData);
                5 -> skip_32_gateway_s_login(Rest, 0, 0, F@_1, F@_2, TrUserData)
            end
    end;
dg_read_field_def_gateway_s_login(<<>>, 0, 0, F@_1, R1, TrUserData) -> #gateway_s_login{account = F@_1, role_list = lists_reverse(R1, TrUserData)}.

d_field_gateway_s_login_account(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) when N < 57 -> d_field_gateway_s_login_account(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_gateway_s_login_account(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, {id(binary:copy(Bytes), TrUserData), Rest2} end,
    dfp_read_field_def_gateway_s_login(RestF, 0, 0, NewFValue, F@_2, TrUserData).

d_field_gateway_s_login_role_list(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) when N < 57 -> d_field_gateway_s_login_role_list(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_gateway_s_login_role_list(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, Prev, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bs:Len/binary, Rest2/binary>> = Rest, {id(decode_msg_gateway_p_role_info(Bs, TrUserData), TrUserData), Rest2} end,
    dfp_read_field_def_gateway_s_login(RestF, 0, 0, F@_1, cons(NewFValue, Prev, TrUserData), TrUserData).

skip_varint_gateway_s_login(<<1:1, _:7, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> skip_varint_gateway_s_login(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
skip_varint_gateway_s_login(<<0:1, _:7, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> dfp_read_field_def_gateway_s_login(Rest, Z1, Z2, F@_1, F@_2, TrUserData).

skip_length_delimited_gateway_s_login(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) when N < 57 -> skip_length_delimited_gateway_s_login(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, TrUserData);
skip_length_delimited_gateway_s_login(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_gateway_s_login(Rest2, 0, 0, F@_1, F@_2, TrUserData).

skip_group_gateway_s_login(Bin, FNum, Z2, F@_1, F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_gateway_s_login(Rest, 0, Z2, F@_1, F@_2, TrUserData).

skip_32_gateway_s_login(<<_:32, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> dfp_read_field_def_gateway_s_login(Rest, Z1, Z2, F@_1, F@_2, TrUserData).

skip_64_gateway_s_login(<<_:64, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> dfp_read_field_def_gateway_s_login(Rest, Z1, Z2, F@_1, F@_2, TrUserData).

decode_msg_gateway_c_select_role(Bin, TrUserData) -> dfp_read_field_def_gateway_c_select_role(Bin, 0, 0, id(0, TrUserData), TrUserData).

dfp_read_field_def_gateway_c_select_role(<<8, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> d_field_gateway_c_select_role_id(Rest, Z1, Z2, F@_1, TrUserData);
dfp_read_field_def_gateway_c_select_role(<<>>, 0, 0, F@_1, _) -> #gateway_c_select_role{id = F@_1};
dfp_read_field_def_gateway_c_select_role(Other, Z1, Z2, F@_1, TrUserData) -> dg_read_field_def_gateway_c_select_role(Other, Z1, Z2, F@_1, TrUserData).

dg_read_field_def_gateway_c_select_role(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_gateway_c_select_role(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_gateway_c_select_role(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        8 -> d_field_gateway_c_select_role_id(Rest, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_gateway_c_select_role(Rest, 0, 0, F@_1, TrUserData);
                1 -> skip_64_gateway_c_select_role(Rest, 0, 0, F@_1, TrUserData);
                2 -> skip_length_delimited_gateway_c_select_role(Rest, 0, 0, F@_1, TrUserData);
                3 -> skip_group_gateway_c_select_role(Rest, Key bsr 3, 0, F@_1, TrUserData);
                5 -> skip_32_gateway_c_select_role(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_gateway_c_select_role(<<>>, 0, 0, F@_1, _) -> #gateway_c_select_role{id = F@_1}.

d_field_gateway_c_select_role_id(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 57 -> d_field_gateway_c_select_role_id(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
d_field_gateway_c_select_role_id(<<0:1, X:7, Rest/binary>>, N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData), Rest},
    dfp_read_field_def_gateway_c_select_role(RestF, 0, 0, NewFValue, TrUserData).

skip_varint_gateway_c_select_role(<<1:1, _:7, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> skip_varint_gateway_c_select_role(Rest, Z1, Z2, F@_1, TrUserData);
skip_varint_gateway_c_select_role(<<0:1, _:7, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_c_select_role(Rest, Z1, Z2, F@_1, TrUserData).

skip_length_delimited_gateway_c_select_role(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 57 -> skip_length_delimited_gateway_c_select_role(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_gateway_c_select_role(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_gateway_c_select_role(Rest2, 0, 0, F@_1, TrUserData).

skip_group_gateway_c_select_role(Bin, FNum, Z2, F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_gateway_c_select_role(Rest, 0, Z2, F@_1, TrUserData).

skip_32_gateway_c_select_role(<<_:32, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_c_select_role(Rest, Z1, Z2, F@_1, TrUserData).

skip_64_gateway_c_select_role(<<_:64, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_c_select_role(Rest, Z1, Z2, F@_1, TrUserData).

decode_msg_gateway_s_select_role(Bin, TrUserData) -> dfp_read_field_def_gateway_s_select_role(Bin, 0, 0, id(0, TrUserData), TrUserData).

dfp_read_field_def_gateway_s_select_role(<<8, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> d_field_gateway_s_select_role_id(Rest, Z1, Z2, F@_1, TrUserData);
dfp_read_field_def_gateway_s_select_role(<<>>, 0, 0, F@_1, _) -> #gateway_s_select_role{id = F@_1};
dfp_read_field_def_gateway_s_select_role(Other, Z1, Z2, F@_1, TrUserData) -> dg_read_field_def_gateway_s_select_role(Other, Z1, Z2, F@_1, TrUserData).

dg_read_field_def_gateway_s_select_role(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_gateway_s_select_role(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_gateway_s_select_role(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        8 -> d_field_gateway_s_select_role_id(Rest, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_gateway_s_select_role(Rest, 0, 0, F@_1, TrUserData);
                1 -> skip_64_gateway_s_select_role(Rest, 0, 0, F@_1, TrUserData);
                2 -> skip_length_delimited_gateway_s_select_role(Rest, 0, 0, F@_1, TrUserData);
                3 -> skip_group_gateway_s_select_role(Rest, Key bsr 3, 0, F@_1, TrUserData);
                5 -> skip_32_gateway_s_select_role(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_gateway_s_select_role(<<>>, 0, 0, F@_1, _) -> #gateway_s_select_role{id = F@_1}.

d_field_gateway_s_select_role_id(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 57 -> d_field_gateway_s_select_role_id(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
d_field_gateway_s_select_role_id(<<0:1, X:7, Rest/binary>>, N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData), Rest},
    dfp_read_field_def_gateway_s_select_role(RestF, 0, 0, NewFValue, TrUserData).

skip_varint_gateway_s_select_role(<<1:1, _:7, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> skip_varint_gateway_s_select_role(Rest, Z1, Z2, F@_1, TrUserData);
skip_varint_gateway_s_select_role(<<0:1, _:7, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_s_select_role(Rest, Z1, Z2, F@_1, TrUserData).

skip_length_delimited_gateway_s_select_role(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 57 -> skip_length_delimited_gateway_s_select_role(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_gateway_s_select_role(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_gateway_s_select_role(Rest2, 0, 0, F@_1, TrUserData).

skip_group_gateway_s_select_role(Bin, FNum, Z2, F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_gateway_s_select_role(Rest, 0, Z2, F@_1, TrUserData).

skip_32_gateway_s_select_role(<<_:32, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_s_select_role(Rest, Z1, Z2, F@_1, TrUserData).
...
dfp_read_field_def_gateway_s_create_role(<<10, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> d_field_gateway_s_create_role_role_list(Rest, Z1, Z2, F@_1, TrUserData);
dfp_read_field_def_gateway_s_create_role(<<>>, 0, 0, R1, TrUserData) -> #gateway_s_create_role{role_list = lists_reverse(R1, TrUserData)};
dfp_read_field_def_gateway_s_create_role(Other, Z1, Z2, F@_1, TrUserData) -> dg_read_field_def_gateway_s_create_role(Other, Z1, Z2, F@_1, TrUserData).

dg_read_field_def_gateway_s_create_role(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_gateway_s_create_role(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_gateway_s_create_role(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_gateway_s_create_role_role_list(Rest, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_gateway_s_create_role(Rest, 0, 0, F@_1, TrUserData);
                1 -> skip_64_gateway_s_create_role(Rest, 0, 0, F@_1, TrUserData);
                2 -> skip_length_delimited_gateway_s_create_role(Rest, 0, 0, F@_1, TrUserData);
                3 -> skip_group_gateway_s_create_role(Rest, Key bsr 3, 0, F@_1, TrUserData);
                5 -> skip_32_gateway_s_create_role(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_gateway_s_create_role(<<>>, 0, 0, R1, TrUserData) -> #gateway_s_create_role{role_list = lists_reverse(R1, TrUserData)}.

d_field_gateway_s_create_role_role_list(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 57 -> d_field_gateway_s_create_role_role_list(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
d_field_gateway_s_create_role_role_list(<<0:1, X:7, Rest/binary>>, N, Acc, Prev, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bs:Len/binary, Rest2/binary>> = Rest, {id(decode_msg_gateway_p_role_info(Bs, TrUserData), TrUserData), Rest2} end,
    dfp_read_field_def_gateway_s_create_role(RestF, 0, 0, cons(NewFValue, Prev, TrUserData), TrUserData).

skip_varint_gateway_s_create_role(<<1:1, _:7, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> skip_varint_gateway_s_create_role(Rest, Z1, Z2, F@_1, TrUserData);
skip_varint_gateway_s_create_role(<<0:1, _:7, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_s_create_role(Rest, Z1, Z2, F@_1, TrUserData).

skip_length_delimited_gateway_s_create_role(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) when N < 57 -> skip_length_delimited_gateway_s_create_role(Rest, N + 7, X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_gateway_s_create_role(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_gateway_s_create_role(Rest2, 0, 0, F@_1, TrUserData).

skip_group_gateway_s_create_role(Bin, FNum, Z2, F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_gateway_s_create_role(Rest, 0, Z2, F@_1, TrUserData).

skip_32_gateway_s_create_role(<<_:32, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_s_create_role(Rest, Z1, Z2, F@_1, TrUserData).

skip_64_gateway_s_create_role(<<_:64, Rest/binary>>, Z1, Z2, F@_1, TrUserData) -> dfp_read_field_def_gateway_s_create_role(Rest, Z1, Z2, F@_1, TrUserData).

decode_msg_gateway_c_heart(Bin, TrUserData) -> dfp_read_field_def_gateway_c_heart(Bin, 0, 0, TrUserData).

dfp_read_field_def_gateway_c_heart(<<>>, 0, 0, _) -> #gateway_c_heart{};
dfp_read_field_def_gateway_c_heart(Other, Z1, Z2, TrUserData) -> dg_read_field_def_gateway_c_heart(Other, Z1, Z2, TrUserData).

dg_read_field_def_gateway_c_heart(<<1:1, X:7, Rest/binary>>, N, Acc, TrUserData) when N < 32 - 7 -> dg_read_field_def_gateway_c_heart(Rest, N + 7, X bsl N + Acc, TrUserData);
dg_read_field_def_gateway_c_heart(<<0:1, X:7, Rest/binary>>, N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
        0 -> skip_varint_gateway_c_heart(Rest, 0, 0, TrUserData);
        1 -> skip_64_gateway_c_heart(Rest, 0, 0, TrUserData);
        2 -> skip_length_delimited_gateway_c_heart(Rest, 0, 0, TrUserData);
        3 -> skip_group_gateway_c_heart(Rest, Key bsr 3, 0, TrUserData);
        5 -> skip_32_gateway_c_heart(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_gateway_c_heart(<<>>, 0, 0, _) -> #gateway_c_heart{}.

skip_varint_gateway_c_heart(<<1:1, _:7, Rest/binary>>, Z1, Z2, TrUserData) -> skip_varint_gateway_c_heart(Rest, Z1, Z2, TrUserData);
skip_varint_gateway_c_heart(<<0:1, _:7, Rest/binary>>, Z1, Z2, TrUserData) -> dfp_read_field_def_gateway_c_heart(Rest, Z1, Z2, TrUserData).

skip_length_delimited_gateway_c_heart(<<1:1, X:7, Rest/binary>>, N, Acc, TrUserData) when N < 57 -> skip_length_delimited_gateway_c_heart(Rest, N + 7, X bsl N + Acc, TrUserData);
skip_length_delimited_gateway_c_heart(<<0:1, X:7, Rest/binary>>, N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_gateway_c_heart(Rest2, 0, 0, TrUserData).

skip_group_gateway_c_heart(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_gateway_c_heart(Rest, 0, Z2, TrUserData).

skip_32_gateway_c_heart(<<_:32, Rest/binary>>, Z1, Z2, TrUserData) -> dfp_read_field_def_gateway_c_heart(Rest, Z1, Z2, TrUserData).

skip_64_gateway_c_heart(<<_:64, Rest/binary>>, Z1, Z2, TrUserData) -> dfp_read_field_def_gateway_c_heart(Rest, Z1, Z2, TrUserData).

decode_msg_gateway_s_heart(Bin, TrUserData) -> dfp_read_field_def_gateway_s_heart(Bin, 0, 0, TrUserData).

dfp_read_field_def_gateway_s_heart(<<>>, 0, 0, _) -> #gateway_s_heart{};
dfp_read_field_def_gateway_s_heart(Other, Z1, Z2, TrUserData) -> dg_read_field_def_gateway_s_heart(Other, Z1, Z2, TrUserData).

dg_read_field_def_gateway_s_heart(<<1:1, X:7, Rest/binary>>, N, Acc, TrUserData) when N < 32 - 7 -> dg_read_field_def_gateway_s_heart(Rest, N + 7, X bsl N + Acc, TrUserData);
dg_read_field_def_gateway_s_heart(<<0:1, X:7, Rest/binary>>, N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
        0 -> skip_varint_gateway_s_heart(Rest, 0, 0, TrUserData);
        1 -> skip_64_gateway_s_heart(Rest, 0, 0, TrUserData);
        2 -> skip_length_delimited_gateway_s_heart(Rest, 0, 0, TrUserData);
        3 -> skip_group_gateway_s_heart(Rest, Key bsr 3, 0, TrUserData);
        5 -> skip_32_gateway_s_heart(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_gateway_s_heart(<<>>, 0, 0, _) -> #gateway_s_heart{}.

skip_varint_gateway_s_heart(<<1:1, _:7, Rest/binary>>, Z1, Z2, TrUserData) -> skip_varint_gateway_s_heart(Rest, Z1, Z2, TrUserData);
skip_varint_gateway_s_heart(<<0:1, _:7, Rest/binary>>, Z1, Z2, TrUserData) -> dfp_read_field_def_gateway_s_heart(Rest, Z1, Z2, TrUserData).

skip_length_delimited_gateway_s_heart(<<1:1, X:7, Rest/binary>>, N, Acc, TrUserData) when N < 57 -> skip_length_delimited_gateway_s_heart(Rest, N + 7, X bsl N + Acc, TrUserData);
skip_length_delimited_gateway_s_heart(<<0:1, X:7, Rest/binary>>, N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_gateway_s_heart(Rest2, 0, 0, TrUserData).

skip_group_gateway_s_heart(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_gateway_s_heart(Rest, 0, Z2, TrUserData).

skip_32_gateway_s_heart(<<_:32, Rest/binary>>, Z1, Z2, TrUserData) -> dfp_read_field_def_gateway_s_heart(Rest, Z1, Z2, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        gateway_c_login -> merge_msg_gateway_c_login(Prev, New, TrUserData);
        gateway_p_role_info -> merge_msg_gateway_p_role_info(Prev, New, TrUserData);
        gateway_s_login -> merge_msg_gateway_s_login(Prev, New, TrUserData);
        gateway_c_select_role -> merge_msg_gateway_c_select_role(Prev, New, TrUserData);
        gateway_s_select_role -> merge_msg_gateway_s_select_role(Prev, New, TrUserData);
...
merge_msg_gateway_c_login(#gateway_c_login{account = PFaccount}, #gateway_c_login{account = NFaccount}, _) ->
...
merge_msg_gateway_s_login(#gateway_s_login{account = PFaccount, role_list = PFrole_list}, #gateway_s_login{account = NFaccount, role_list = NFrole_list}, TrUserData) ->
...
-compile({nowarn_unused_function,merge_msg_gateway_c_select_role/3}).
merge_msg_gateway_c_select_role(#gateway_c_select_role{id = PFid}, #gateway_c_select_role{id = NFid}, _) ->
    #gateway_c_select_role{id =
                               if NFid =:= undefined -> PFid;
                                  true -> NFid
                               end}.

-compile({nowarn_unused_function,merge_msg_gateway_s_select_role/3}).
merge_msg_gateway_s_select_role(#gateway_s_select_role{id = PFid}, #gateway_s_select_role{id = NFid}, _) ->
...
merge_msg_gateway_s_create_role(#gateway_s_create_role{role_list = PFrole_list}, #gateway_s_create_role{role_list = NFrole_list}, TrUserData) ->
    #gateway_s_create_role{role_list =
                               if PFrole_list /= undefined, NFrole_list /= undefined -> 'erlang_++'(PFrole_list, NFrole_list, TrUserData);
                                  PFrole_list == undefined -> NFrole_list;
                                  NFrole_list == undefined -> PFrole_list
                               end}.

-compile({nowarn_unused_function,merge_msg_gateway_c_heart/3}).
merge_msg_gateway_c_heart(_Prev, New, _TrUserData) -> New.
...
verify_msg(Msg, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        gateway_c_login -> v_msg_gateway_c_login(Msg, [MsgName], TrUserData);
        gateway_p_role_info -> v_msg_gateway_p_role_info(Msg, [MsgName], TrUserData);
        gateway_s_login -> v_msg_gateway_s_login(Msg, [MsgName], TrUserData);
        gateway_c_select_role -> v_msg_gateway_c_select_role(Msg, [MsgName], TrUserData);
        gateway_s_select_role -> v_msg_gateway_s_select_role(Msg, [MsgName], TrUserData);
        gateway_c_create_role -> v_msg_gateway_c_create_role(Msg, [MsgName], TrUserData);
...
-compile({nowarn_unused_function,v_msg_gateway_c_login/3}).
-dialyzer({nowarn_function,v_msg_gateway_c_login/3}).
v_msg_gateway_c_login(#gateway_c_login{account = F1}, Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_type_string(F1, [account | Path], TrUserData)
    end,
    ok;
v_msg_gateway_c_login(X, Path, _TrUserData) -> mk_type_error({expected_msg, gateway_c_login}, X, Path).
...
-compile({nowarn_unused_function,v_msg_gateway_s_login/3}).
-dialyzer({nowarn_function,v_msg_gateway_s_login/3}).
v_msg_gateway_s_login(#gateway_s_login{account = F1, role_list = F2}, Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_type_string(F1, [account | Path], TrUserData)
    end,
    if is_list(F2) ->
           _ = [v_msg_gateway_p_role_info(Elem, [role_list | Path], TrUserData) || Elem <- F2],
           ok;
       true -> mk_type_error({invalid_list_of, {msg, gateway_p_role_info}}, F2, [role_list | Path])
    end,
    ok;
v_msg_gateway_s_login(X, Path, _TrUserData) -> mk_type_error({expected_msg, gateway_s_login}, X, Path).

-compile({nowarn_unused_function,v_msg_gateway_c_select_role/3}).
-dialyzer({nowarn_function,v_msg_gateway_c_select_role/3}).
v_msg_gateway_c_select_role(#gateway_c_select_role{id = F1}, Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_type_uint32(F1, [id | Path], TrUserData)
    end,
    ok;
v_msg_gateway_c_select_role(X, Path, _TrUserData) -> mk_type_error({expected_msg, gateway_c_select_role}, X, Path).

-compile({nowarn_unused_function,v_msg_gateway_s_select_role/3}).
-dialyzer({nowarn_function,v_msg_gateway_s_select_role/3}).
v_msg_gateway_s_select_role(#gateway_s_select_role{id = F1}, Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_type_uint32(F1, [id | Path], TrUserData)
    end,
    ok;
v_msg_gateway_s_select_role(X, Path, _TrUserData) -> mk_type_error({expected_msg, gateway_s_select_role}, X, Path).
...
-compile({nowarn_unused_function,v_msg_gateway_s_create_role/3}).
-dialyzer({nowarn_function,v_msg_gateway_s_create_role/3}).
v_msg_gateway_s_create_role(#gateway_s_create_role{role_list = F1}, Path, TrUserData) ->
    if is_list(F1) ->
           _ = [v_msg_gateway_p_role_info(Elem, [role_list | Path], TrUserData) || Elem <- F1],
           ok;
       true -> mk_type_error({invalid_list_of, {msg, gateway_p_role_info}}, F1, [role_list | Path])
    end,
    ok;
v_msg_gateway_s_create_role(X, Path, _TrUserData) -> mk_type_error({expected_msg, gateway_s_create_role}, X, Path).

-compile({nowarn_unused_function,v_msg_gateway_c_heart/3}).
-dialyzer({nowarn_function,v_msg_gateway_c_heart/3}).
v_msg_gateway_c_heart(#gateway_c_heart{}, _Path, _) -> ok;
v_msg_gateway_c_heart(X, Path, _TrUserData) -> mk_type_error({expected_msg, gateway_c_heart}, X, Path).

-compile({nowarn_unused_function,v_msg_gateway_s_heart/3}).
-dialyzer({nowarn_function,v_msg_gateway_s_heart/3}).
...
fqbin_to_msg_name(<<"gateway_c_login">>) -> gateway_c_login;
fqbin_to_msg_name(<<"gateway_p_role_info">>) -> gateway_p_role_info;
fqbin_to_msg_name(<<"gateway_s_login">>) -> gateway_s_login;
fqbin_to_msg_name(<<"gateway_c_select_role">>) -> gateway_c_select_role;
fqbin_to_msg_name(<<"gateway_s_select_role">>) -> gateway_s_select_role;
fqbin_to_msg_name(<<"gateway_c_create_role">>) -> gateway_c_create_role;
...
msg_name_to_fqbin(gateway_c_login) -> <<"gateway_c_login">>;
msg_name_to_fqbin(gateway_p_role_info) -> <<"gateway_p_role_info">>;
msg_name_to_fqbin(gateway_s_login) -> <<"gateway_s_login">>;
msg_name_to_fqbin(gateway_c_select_role) -> <<"gateway_c_select_role">>;
msg_name_to_fqbin(gateway_s_select_role) -> <<"gateway_s_select_role">>;
msg_name_to_fqbin(gateway_c_create_role) -> <<"gateway_c_create_role">>;
...
source_basename() -> "gateway_12.proto".
...
get_all_source_basenames() -> ["gateway_12.proto"].
...
get_pkg_containment("gateway_12") -> undefined;
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).


get_service_containment("gateway_12") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).


get_rpc_containment("gateway_12") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).


get_enum_containment("gateway_12") -> [];
...
get_proto_by_msg_name_as_fqbin(<<"gateway_p_role_info">>) -> "gateway_12";
